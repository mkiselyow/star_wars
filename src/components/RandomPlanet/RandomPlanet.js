  ...
  render() {
    return (
      <article className='person-details container'>
        <div className='row'>
          <div className='col-12 col-sm-6 col-md-3 offset-md-3 d-flex justify-content-center'>
            <figure>
          ...
          <div className='col-12 col-md-3 col-sm-6 d-flex justify-content-center align-content-middle'>
